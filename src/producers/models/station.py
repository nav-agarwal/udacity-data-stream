...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        topic_name = TOPIC_NAMES.TRAIN_ARRIVALS_V1
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        logger.info("arrival kafka integration publishing")
        ...
        try:
            ...
            logger.error("Exceptin while publishing the message " + e)

        logger.info("arrival kafka integration published")
