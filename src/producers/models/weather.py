...
class Weather(Producer):
    ...
    def __init__(self, month):
        ...
        self.topic_name = TOPIC_NAMES.WEATHER_TEMPERATURE_V1
        super().__init__(
            self.topic_name, # Done: Come up with a better topic name
    ...
    def run(self, month):
        ...
        #
        #
        logger.info("weather kafka proxy integration entrypoint")
        url = "{endpoint}/topics/{topic_name}".format(endpoint=SystemConfiguration.REST_PROXY_URL, topic_name=self.topic_name)
